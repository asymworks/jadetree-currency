...
// Locale Data
export const ta_LK = new Locale(
  'ta_LK',
  { c: 'LKR', cs: { LKR: 'Rs.' }, cn: {} },
  ta
);
export const ta_MY = new Locale(
  'ta_MY',
  { c: 'MYR', cs: { MYR: 'RM', SGD: 'S$' }, cn: {} },
  ta
);
export const ta_SG = new Locale(
  'ta_SG',
  { c: 'SGD', cs: { MYR: 'RM', SGD: '$' }, cn: {} },
  ta
);
export const ta_IN = new Locale('ta_IN', { c: 'INR' }, ta);
