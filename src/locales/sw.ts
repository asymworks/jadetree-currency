...
export const sw_UG = new Locale(
  'sw_UG',
  { c: 'UGX', cs: { UGX: 'USh' }, cn: {} },
  sw
);
export const sw_TZ = new Locale('sw_TZ', { c: 'TZS' }, sw);
