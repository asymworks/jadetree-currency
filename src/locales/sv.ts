...
// Locale Data
export const sv_AX = new Locale('sv_AX', { c: 'EUR', cs: {}, cn: {} }, sv);
export const sv_FI = new Locale('sv_FI', { c: 'EUR', cs: {}, cn: {} }, sv);
export const sv_SE = new Locale('sv_SE', { c: 'SEK' }, sv);
