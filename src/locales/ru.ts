...
// Locale Data
export const ru_BY = new Locale(
  'ru_BY',
  { c: 'BYN', cs: { BYN: 'Br' }, cn: {} },
  ru
);
export const ru_KG = new Locale(
  'ru_KG',
  { c: 'KGS', cs: { KGS: 'сом' }, cn: {} },
  ru
);
export const ru_KZ = new Locale(
  'ru_KZ',
  { c: 'KZT', cs: { KZT: '₸' }, cn: {} },
  ru
);
export const ru_MD = new Locale(
  'ru_MD',
  { c: 'MDL', cs: { MDL: 'L' }, cn: {} },
  ru
);
export const ru_UA = new Locale('ru_UA', { c: 'UAH', cs: {}, cn: {} }, ru);
export const ru_RU = new Locale('ru_RU', { c: 'RUB' }, ru);
