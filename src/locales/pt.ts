...
// Locale Data
export const pt_AO = new Locale(
  'pt_AO',
  { c: 'AOA', cs: { AOA: 'Kz' }, cn: {} },
  pt_PT
);
export const pt_CH = new Locale('pt_CH', { c: 'CHF', cs: {}, cn: {} }, pt_PT);
export const pt_CV = new Locale(
  'pt_CV',
  { c: 'CVE', cs: { CVE: '​' }, cn: {} },
  pt_PT
);
export const pt_GQ = new Locale('pt_GQ', { c: 'XAF', cs: {}, cn: {} }, pt_PT);
export const pt_GW = new Locale('pt_GW', { c: 'XOF', cs: {}, cn: {} }, pt_PT);
export const pt_LU = new Locale('pt_LU', { cs: {}, cn: {} }, pt_PT);
export const pt_MO = new Locale(
  'pt_MO',
  { c: 'MOP', cs: { MOP: 'MOP$' }, cn: {} },
  pt_PT
);
export const pt_MZ = new Locale(
  'pt_MZ',
  { c: 'MZN', cs: { MZN: 'MTn' }, cn: {} },
  pt_PT
);
export const pt_ST = new Locale(
  'pt_ST',
  { c: 'STN', cs: { STN: 'Db' }, cn: {} },
  pt_PT
);
export const pt_TL = new Locale('pt_TL', { c: 'USD', cs: {}, cn: {} }, pt_PT);
export const pt_BR = new Locale('pt_BR', { c: 'BRL' }, pt);
