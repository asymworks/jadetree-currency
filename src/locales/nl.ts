...
export const nl = new Locale(
  'nl',
  {
    d: ',',
    g: '.',
    cs: { AUD: 'AU$', CAD: 'C$', FJD: 'FJ$', SBD: 'SI$', THB: '฿' },
    cn: {
...
// Locale Data
export const nl_AW = new Locale(
  'nl_AW',
  { c: 'AWG', cs: { AWG: 'Afl.' }, cn: {} },
  nl
);
export const nl_BE = new Locale('nl_BE', { c: 'EUR', cs: {}, cn: {} }, nl);
export const nl_BQ = new Locale(
  'nl_BQ',
  { c: 'USD', cs: { USD: '$' }, cn: {} },
  nl
);
export const nl_CW = new Locale(
  'nl_CW',
  { c: 'ANG', cs: { ANG: 'NAf.' }, cn: {} },
  nl
);
export const nl_SR = new Locale(
  'nl_SR',
  { c: 'SRD', cs: { SRD: '$' }, cn: {} },
  nl
);
export const nl_SX = new Locale(
  'nl_SX',
  { c: 'ANG', cs: { ANG: 'NAf.' }, cn: {} },
  nl
);
export const nl_NL = new Locale('nl_NL', { c: 'EUR' }, nl);
